...
export function agentScreenshotPath(marker: string, name: "01-ready.png" | "02-approval.png" | "03-published.png" | "04-release.png") { return path.join(agentOutputDirectory(marker), name); }
