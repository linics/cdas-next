...
const bindingFields = [
  ...
  "STAGING_TEST_TEACHER_CLERK_ID", "STAGING_TEST_STUDENT_CLERK_ID", "STAGING_TEST_OTHER_STUDENT_CLERK_ID", "STAGING_DATABASE_NAME", "STAGING_BASE_URL", "AI_PROVIDER_DISABLED",
