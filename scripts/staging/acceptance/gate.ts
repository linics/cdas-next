...
const coreBindingFields = [
  ...
  "STAGING_TEST_TEACHER_CLERK_ID", "STAGING_TEST_STUDENT_CLERK_ID", "STAGING_TEST_OTHER_STUDENT_CLERK_ID", "STAGING_TEST_OTHER_TEACHER_CLERK_ID", "STAGING_DATABASE_NAME", "STAGING_BASE_URL", "STAGING_VERCEL_PROJECT_NAME", "STAGING_DEPLOYMENT_PROTECTION_REQUIRED", "AI_PROVIDER_DISABLED",
