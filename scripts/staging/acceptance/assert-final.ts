...
function passingVerify(value: unknown): boolean {
  const codes = ["NAMESPACE_CLASSROOM_AND_MEMBERSHIPS_EXACT", "MANUAL_DRAFT_RELEASE_SUBMISSION_FEEDBACK_CLOSED", "PRIVATE_ATTACHMENT_READY_AND_FORMALIZED", "SNAPSHOT_INTENTS_AUDITS_AND_STALE_CLOSE_REJECTION", "OTHER_STUDENT_HAS_NO_SUBMISSION_HISTORY"];
