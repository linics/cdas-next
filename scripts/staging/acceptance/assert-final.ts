...
function passingVerify(value: unknown): boolean {
  const codes = ["NAMESPACE_CLASSROOM_AND_MEMBERSHIPS_EXACT", "MEMBERSHIP_HISTORY_INTENTS_AND_AUDITS_EXACT", "MANUAL_PHASED_DRAFT_RELEASE_SUBMISSIONS_FEEDBACK_CLOSED", "VERSIONED_PHASE_SUBMISSIONS_AND_CHECKPOINTS_EXACT", "PRIVATE_ATTACHMENT_READY_AND_FORMALIZED", "SNAPSHOT_INTENTS_AUDITS_AND_STALE_CLOSE_REJECTION", "OTHER_STUDENT_HAS_NO_SUBMISSION_HISTORY"];
