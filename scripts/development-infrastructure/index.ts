...
import { deployMigrationsWithMinimalEnvironment, SafeCommandRunner } from "./providers";
    ...
    verifyApplication: async (input) => {
      await runner.run("pnpm", ["staging:verify-application"], {
        env: {
          ...
          STAGING_AUTH_MODE: input.authMode,
          STAGING_BASE_URL: input.baseUrl,
          STAGING_VERCEL_PROJECT_NAME: input.projectName,
          ...
          CDAS_DEPLOYMENT_ID: input.deploymentSha,
        },
      });
    },
