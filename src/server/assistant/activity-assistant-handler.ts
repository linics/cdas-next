...
4. 对与当前活动相关的检索结果，调 read_source_section 阅读原文后再写目标、学科贡献、证据与评价。若活动学科命中首版白名单，提案必须引用至少两个不同官方来源；引用的 sourceId、sectionId、citationLabel 与 href 必须逐字来自工具结果。引用只是可追查的设计依据，不代表活动自动符合课程标准。若确实没有相关结果，应明确说明首版语料边界，不能编造来源。
