...
export const waterConservationTaskBook = {
  ...
  durationWeeks: 2,
  backgroundSetting: "学校准备开展节水行动，同学们要从校园中的真实用水场景出发，提出可以执行的改进建议。",
  ...
  taskInstructions: "围绕一个校园用水场景，完成观察与调查、数据分析和改进建议公开表达，形成有证据的节水行动方案。",
  evidenceRequirements: ["带有时间和地点的观察记录", "整理后的统计表或图表", "节水行动建议稿"],
  feedbackCriteria: ["问题意识", "证据质量", "跨学科连接", "方案表达"],
  phases: [
    { name: "观察与问题界定", action: "观察一个校园用水场景并界定可调查的问题。", context: "从洗手间、饮水区或绿化浇灌等真实场景中选择对象。", support: "使用观察记录表标注时间、地点、行为与影响。", evidence: [{ type: "text", description: "带时间、地点和现象的观察记录" }], evaluationFocus: "问题是否来自真实场景且表述清楚。", suggestedLessons: 1 },
    { name: "调查与分析", action: "整理观察或问卷数据，解释一个用水问题。", context: "比较不同时间、地点或行为的数据。", support: "使用统计表、频数或简单图表整理数据。", evidence: [{ type: "document", description: "统计表或图表及简要分析" }], evaluationFocus: "判断是否有可靠证据支持。", suggestedLessons: 1 },
    { name: "建议与公开表达", action: "提出并公开表达至少两条可执行的节水建议。", context: "面向校园中明确的行动对象沟通建议。", support: "按现象、证据、建议的结构组织表达。", evidence: [{ type: "text", description: "包含证据依据的节水建议稿" }], evaluationFocus: "建议是否具体、可执行并与证据对应。", suggestedLessons: 1 },
  ],
  rubricDimensions: [
